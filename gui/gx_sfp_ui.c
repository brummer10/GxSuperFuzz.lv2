...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    *widget = NULL;
    ...
    const char* plug_name = "GxSuperFuzz" ;
    ...
    ui->label[1] = gtk_label_new("EXPANDER");
    ...
    ui->adj[3] = gtk_adjustment_new( 0.25, 0.0, 0.49, 0.01, 0.01*10.0, 0);
    ui->knob[3] = gtk_trimmpot_new_with_adjustment(GTK_ADJUSTMENT(ui->adj[3]));
    ui->label[3] = gtk_label_new("TRIM");
    ...
    pango_font_description_set_weight(style->font_desc, PANGO_WEIGHT_MEDIUM);
    ...
    gtk_box_pack_end(GTK_BOX(ui->thbox), ui->vkbox[3], FALSE, FALSE, 30);
    gtk_box_pack_start(GTK_BOX(ui->vkbox[3]), ui->label[3], FALSE, FALSE, 0);
    gtk_box_pack_start(GTK_BOX(ui->vkbox[3]), ui->knob[3], FALSE, FALSE, 0);
    ui->args[3] = (struct gx_args*) malloc(sizeof(struct gx_args));
    ui->args[3]->ui = ui;
    ui->args[3]->port_index = (int)TRIM;
    ...
    ui->label[0] = gtk_label_new("BALANCE");
    ...
    ui->args[0]->ui = ui;
    ui->args[0]->port_index = (int)BALANCE;
